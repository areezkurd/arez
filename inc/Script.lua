...
return '👨🏾‍🔧│ اصدار سورس ستيفن  : *v'..version..'* \n📡'
end
...
local inline = {{{text="⚜│قناه السـورس ضـغـط هنا ",url="https://t.me/STEVN_STORE"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : ستيفن](https://t.me/STEVN_STORE)',nil,inline,msg.id_)
return false
end
...
🧔🏻|[مطور الـسـورس](https://t.me/pp_sa)
📨│ [قناه السورس](https://t.me/STEVN_STORE)
